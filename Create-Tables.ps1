...
@{Name="CertificateEffectiveDate";Type=[Microsoft.SqlServer.Management.Smo.DataType]::NVarChar(128);Nullable=$True},
@{Name="CertificateExpirationDate";Type=[Microsoft.SqlServer.Management.Smo.DataType]::NVarChar(128);Nullable=$True},
